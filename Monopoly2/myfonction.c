...
menuvente://
	...
	case 5://
		...
		printf("\nSale completed!\n");//
		printf("%s: 1 Hotel was sold by %s.\n", Proprietes[numerodelapropriete].Nom, Joueures[i].Nom);//
		printf("\n///////////////////////////////////////\n");
		fflush(stdin);//
		getchar();//
    ...
    case 3:
		...
		printf("\nSale completed!\n");//
		printf("%s: All constructions was sold by %s.\n", Proprietes[numerodelapropriete].Nom, Joueures[i].Nom);//
		printf("\n///////////////////////////////////////\n");
		fflush(stdin);//
		getchar();//
        break;
...
void acheterProprieteEn(int player)//
{
	...
	if ((Joueures[i].compte >= Proprietes[Joueures[i].position].prix)&&(strcmp(Proprietes[Joueures[i].position].proprietaire, "no owner") == 0)&&(Proprietes[Joueures[i].position].hypotheque == false))//
    {
...
void construireHotelEn(int player)
{
	...
	for (int j = 0; j < 40; j++)//
        {
            if ((strcmp(Proprietes[j].proprietaire, Joueures[i].Nom) == 0)&&(strcmp(Proprietes[j].Couleur,"Station") != 0)&&(strcmp(Proprietes[j].Couleur, "Services") != 0))//
                {
                    printf(" %d   * %s\n",j,Proprietes[j].Nom);//
                    nombreDepropriete++;
                }
    ...
    {
        do{
        printf("enter the number of the property where a hotel is to be built \n");//
        scanf("%d", &numerodelapropriete);//
        }while((strcmp(Proprietes[numerodelapropriete].proprietaire, Joueures[i].Nom) != 0)&&(strcmp(Proprietes[numerodelapropriete].Couleur,"Station") == 0)&&(strcmp(Proprietes[numerodelapropriete].Couleur, "Services") == 0));//
        ...
        if ((Proprietes[numerodelapropriete].nombreDeMaisons >= 4)&&(Proprietes[numerodelapropriete].nombreHotel <1)&&((Joueures[i].compte -= Proprietes[numerodelapropriete].prixMaison)>0))
        {
            if (Batiments.nHotel>0)
            {
                ...
                Batiments.nHotel -= 1;
                printf("Current account of %s : %d\n",Joueures[i].Nom ,Joueures[i].compte);
                printf("successfully built Hotel !\n");//
                printf("This property now has %d house(s) and a Hotel.\n", Proprietes[numerodelapropriete].nombreDeMaisons); //
            }
            else
            {
                printf("It has no more hotels wait for players to sell them.");//
            }

        }
        else printf("You need 4 houses on the same property to build a hotel.");//
    }
    else
    {
        printf("You have no property");
...
void construireMaisonEn(int player)
{
    ...
    if (nombreDepropriete>0)
    {
        ...
        for (int l = 0; l < 40; l++)//
            ...
            else if ((Couleurcompteur == 2)&&(strcmp(Proprietes[numerodelapropriete].Couleur,"Brown") == 0)&&((Joueures[i].compte -= Proprietes[numerodelapropriete].prixMaison)>0))//
            {
                    if (Batiments.nMaison>0)
                        {
                            if (Proprietes[numerodelapropriete].nombreDeMaisons<4)
            ...
            else if ((Couleurcompteur == 2)&&(strcmp(Proprietes[numerodelapropriete].Couleur,"Dark blue") == 0)&&((Joueures[i].compte -= Proprietes[numerodelapropriete].prixMaison)>0))//
            {
                    if (Batiments.nMaison>0)
                        {
                            if (Proprietes[numerodelapropriete].nombreDeMaisons<4)
...
menuInitial://
	...
	case 2: printf("Not yet implemented!"); //A faire
		break;
    case 3: printf("Not yet implemented!"); //A faire
		break;
	case 4:
...
nouveauJeu ://
	...
	scanf("%d", &plateau);//
	}while(((plateau < 1)||(plateau > 7))&&(plateau != 101917));
	if (plateau==1)
    {
       initialiseTableEn();//
    }
	...
	do
	{
        ...
        if(Proprietes[Joueures[i].position].hypotheque== true){printf("\n |                                 |   * Mortgage        : Yes\n");}
			...
			if ((Proprietes[Joueures[i].position].prix != 0)&&(strcmp(Proprietes[Joueures[i].position].Couleur, "Station") != 0)&&(strcmp(Proprietes[Joueures[i].position].Couleur, "Services") == 0))//
			{
				...
				printf(" ___________________________________\n");
				printf(" |                                  |\n");
				printf(" |%-34.34s|   * Owner : %s", Proprietes[Joueures[i].position].Nom, Proprietes[Joueures[i].position].proprietaire);//
        if(Proprietes[Joueures[i].position].hypotheque== true){printf("\n |                                  |   * Mortgage        : Yes\n");}
          else {printf("\n |                                  |   * Mortgage        : NON\n");}
            ...
            if (strcmp(Proprietes[Joueures[i].position].Nom, "Community Chest") == 0)//
			{
			    ancienneposition = Joueures[i].position;
				printf("\n             %s           \n", Proprietes[Joueures[i].position].Nom);//
			...
			if (strcmp(Proprietes[Joueures[i].position].Nom, "SUPER TAX") == 0)//
			{
				printf("\n             %s           \n", Proprietes[Joueures[i].position].Nom);//
			...
			if (strcmp(Proprietes[Joueures[i].position].Nom, "INCOME TAX") == 0)//
			{
				printf("\n             %s           \n", Proprietes[Joueures[i].position].Nom);//
			...
			if ((strcmp(Proprietes[Joueures[i].position].Nom, "JAIL - VISITOR") == 0) && (strcmp(Proprietes[i].Nom, "FREE PARKING") == 0))//
            {
                printf("\n             %s           \n", Proprietes[Joueures[i].position].Nom);//
            }
			if (strcmp(Proprietes[Joueures[i].position].Nom, "GO TO JAIL") == 0)//
			{
				Joueures[i].prison = true;
			}
