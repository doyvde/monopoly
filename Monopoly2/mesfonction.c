...
void initialiseTable3()
{
	...
	//Case 5 - GARE
	strcpy(Proprietes[5].Nom, "Uberchar de Montparnix");//
	strcpy(Proprietes[5].Couleur, "Gare");//
	Proprietes[5].prix = 200;//
	Proprietes[5].hypotheque = false;//
	strcpy(Proprietes[5].proprietaire, "aucun proprietaire");//
	...
	//Case 15 - GARE
	strcpy(Proprietes[15].Nom, "Gare de Lugdunum");//
	strcpy(Proprietes[15].Couleur, "Gare");//
	Proprietes[15].prix = 200;//
	Proprietes[15].hypotheque = false;//
	strcpy(Proprietes[15].proprietaire, "aucun proprietaire");//
	...
	//Case 25 - GARE
	strcpy(Proprietes[25].Nom, "Uberchar des breton");//
	strcpy(Proprietes[25].Couleur, "Gare");//
	Proprietes[25].prix = 200;//
	Proprietes[25].hypotheque = false;//
	strcpy(Proprietes[25].proprietaire, "aucun proprietaire");//
	...
	//Case 35 - GARE
	strcpy(Proprietes[35].Nom, "Gare de Londinium");//
	strcpy(Proprietes[35].Couleur, "Gare");//
	Proprietes[35].prix = 200;//
	Proprietes[35].hypotheque = false;//
	strcpy(Proprietes[35].proprietaire, "aucun proprietaire");//
...
void initialiseTable6()
{
	...
	//Case 1
	strcpy(Proprietes[1].Nom, "VA EN PRISON");//
	Proprietes[1].prix = 0;//
    strcpy(Proprietes[1].proprietaire, "Interdit");
	...
	//Case 3
	strcpy(Proprietes[3].Nom, "VA EN PRISON");//
	Proprietes[3].prix = 0;//
    strcpy(Proprietes[3].proprietaire, "Interdit");

	//Case 4 - IMPÔT SUR LE CAPITAL (M200)
	strcpy(Proprietes[4].Nom, "VA EN PRISON");//
	Proprietes[4].prix = 0;//
    strcpy(Proprietes[4].proprietaire, "Interdit");

	//Case 5 - GARE
	strcpy(Proprietes[5].Nom, "VA EN PRISON");//
	Proprietes[5].prix = 0;//
    strcpy(Proprietes[5].proprietaire, "Interdit");

	//Case 6
	strcpy(Proprietes[6].Nom, "VA EN PRISON");//
	Proprietes[6].prix = 0;//
    strcpy(Proprietes[6].proprietaire, "Interdit");
	...
	//Case 8
	strcpy(Proprietes[8].Nom, "VA EN PRISON");//
	Proprietes[8].prix = 0;//
    strcpy(Proprietes[8].proprietaire, "Interdit");

	//Case 9
	strcpy(Proprietes[9].Nom, "VA EN PRISON");//
	Proprietes[9].prix = 0;//
    strcpy(Proprietes[9].proprietaire, "Interdit");
	...
	//Case 11
	strcpy(Proprietes[11].Nom, "VA EN PRISON");//
	Proprietes[11].prix = 0;//
    strcpy(Proprietes[11].proprietaire, "Interdit");

	//Case 12 - COMPAGNIE D'ELETRECITE
	strcpy(Proprietes[12].Nom, "VA EN PRISON");//
	Proprietes[12].prix = 0;//
    strcpy(Proprietes[12].proprietaire, "Interdit");

	//Case 13
	strcpy(Proprietes[13].Nom, "VA EN PRISON");//
	Proprietes[13].prix = 0;//
    strcpy(Proprietes[13].proprietaire, "Interdit");

	//Case 14
	strcpy(Proprietes[14].Nom, "VA EN PRISON");//
	Proprietes[14].prix = 0;//
    strcpy(Proprietes[14].proprietaire, "Interdit");

	//Case 15 - GARE
	strcpy(Proprietes[15].Nom, "VA EN PRISON");//
	Proprietes[15].prix = 0;//
    strcpy(Proprietes[15].proprietaire, "Interdit");

	//Case 16
	strcpy(Proprietes[16].Nom, "VA EN PRISON");//
	Proprietes[16].prix = 0;//
    strcpy(Proprietes[16].proprietaire, "Interdit");
	...
	//Case 18
	strcpy(Proprietes[18].Nom, "VA EN PRISON");//
	Proprietes[18].prix = 0;//
    strcpy(Proprietes[18].proprietaire, "Interdit");

	//Case 19
	strcpy(Proprietes[19].Nom, "VA EN PRISON");//
	Proprietes[19].prix = 0;//
    strcpy(Proprietes[19].proprietaire, "Interdit");
	...
	//Case 21
	strcpy(Proprietes[21].Nom, "VA EN PRISON");//
	Proprietes[21].prix = 0;//
    strcpy(Proprietes[21].proprietaire, "Interdit");
	...
	//Case 23
	strcpy(Proprietes[23].Nom, "VA EN PRISON");//
	Proprietes[23].prix = 0;//
    strcpy(Proprietes[23].proprietaire, "Interdit");

	//Case 24
	strcpy(Proprietes[24].Nom, "VA EN PRISON");//
	Proprietes[24].prix = 0;//
    strcpy(Proprietes[24].proprietaire, "Interdit");

	//Case 25 - GARE
	strcpy(Proprietes[25].Nom, "VA EN PRISON");//
	Proprietes[25].prix = 0;//
    strcpy(Proprietes[25].proprietaire, "Interdit");

	//Case 26
	strcpy(Proprietes[26].Nom, "VA EN PRISON");//
	Proprietes[26].prix = 0;//
    strcpy(Proprietes[26].proprietaire, "Interdit");

	//Case 27
	strcpy(Proprietes[27].Nom, "VA EN PRISON");//
	Proprietes[27].prix = 0;//
    strcpy(Proprietes[27].proprietaire, "Interdit");

	//Case 28 - COMPAGNIE DE L'EAU
	strcpy(Proprietes[28].Nom, "VA EN PRISON");//
	Proprietes[28].prix = 0;//
    strcpy(Proprietes[28].proprietaire, "Interdit");

	//Case 29
	strcpy(Proprietes[29].Nom, "VA EN PRISON");//
	Proprietes[29].prix = 0;//
    strcpy(Proprietes[29].proprietaire, "Interdit");
	...
	//Case 31
	strcpy(Proprietes[31].Nom, "VA EN PRISON");//
	Proprietes[31].prix = 0;//
    strcpy(Proprietes[31].proprietaire, "Interdit");

	//Case 32
	strcpy(Proprietes[32].Nom, "VA EN PRISON");//
	Proprietes[32].prix = 0;//
    strcpy(Proprietes[32].proprietaire, "Interdit");
	...
	//Case 34
	strcpy(Proprietes[34].Nom, "VA EN PRISON");//
	Proprietes[34].prix = 0;//
    strcpy(Proprietes[34].proprietaire, "Interdit");

	//Case 35 - GARE
	strcpy(Proprietes[35].Nom, "VA EN PRISON");//
	Proprietes[35].prix = 0;//
    strcpy(Proprietes[35].proprietaire, "Interdit");
	...
	//Case 37
	strcpy(Proprietes[37].Nom, "VA EN PRISON");//
	Proprietes[37].prix = 0;//
    strcpy(Proprietes[37].proprietaire, "Interdit");

	//Case 38 - TAXE DE LUXE
	strcpy(Proprietes[38].Nom, "VA EN PRISON");//
	Proprietes[38].prix = 0;//
    strcpy(Proprietes[38].proprietaire, "Interdit");

	//Case 39
	strcpy(Proprietes[39].Nom, "VA EN PRISON");//
	Proprietes[39].prix = 0;//
    strcpy(Proprietes[39].proprietaire, "Interdit");
}
...
void vendreConstruction(int player)//
{
    ...
    if (nombreDepropriete>0)
    {
        ...
        if (Proprietes[numerodelapropriete].nombreHotel>0)
        {
            do{
        ...
        else if ((Proprietes[numerodelapropriete].nombreDeMaisons>0))
        {
            do{
...
menuvente://
	...
	case 5://
		...
		printf("\nVente termine!\n");//
		printf("%s : 1 hotel a ete vendu par %s.\n", Proprietes[numerodelapropriete].Nom, Joueures[i].Nom);//
		fflush(stdin);//
		getchar();//
		break;//
    case 3:
        Proprietes[numerodelapropriete].nombreHotel=0;//
        Proprietes[numerodelapropriete].nombreDeMaisons =0;
        Joueures[i].compte += 5*(Proprietes[numerodelapropriete].prixMaison/2) ;//
        Batiments.nHotel += 1;


		printf("\nVente termine!\n");//
		printf("%s: toute les construcions ont ete vendu par %s.\n", Proprietes[numerodelapropriete].Nom, Joueures[i].Nom);//
		fflush(stdin);//
		getchar();//
        break;
    case 4:
...
do {
        menuFaillite://
            ...
            else if (nombreDepropriete<0)
            {
                printf("Vous n'avez pas de propriete\n");
                printf("\n %s vous avez perdu !\n",Joueures[i].Nom);
                for(i= player,j=(player+1);i < nJoueures;i++,j++)
                {
                    Joueures[i]= Joueures[j];//
...
void loyer(int player, int nJoueures)
{
    ...
    int nbhotel=Proprietes[Joueures[i].position].nombreHotel;
    for (j=0;j<nJoueures;j++)
    {
        ...
        else if ((strcmp(Proprietes[Joueures[i].position].proprietaire, Joueures[j].Nom) == 0)&&(strcmp(Proprietes[Joueures[i].position].Couleur,"Gare") != 0)&&(strcmp(Proprietes[Joueures[i].position].Couleur, "Services") != 0)&&(Proprietes[Joueures[i].position].hypotheque==false)&&(strcmp(Joueures[i].Nom, Joueures[j].Nom)!= 0))
        {
            ...
            Joueures[i].compte -= Proprietes[Joueures[i].position].loyer[(nbmaison+nbhotel)] ;
            Joueures[j].compte += Proprietes[Joueures[i].position].loyer[(nbmaison+nbhotel)] ;
            printf("virement accompli !!\n");
		...
		case 2:
			...
			for (int i = 0; i < 40; i++)//
			{
				...
				else
				{
					...
					{
						if (Proprietes[i].nombreDeMaisons == 4)//
						{
							printf("        Maison        : 4\n");//
							printf("        HOTEL        : %d\n", Proprietes[i].nombreHotel);//
						}
						else
						{
...
void acheterPropriete(int player)//
{
	...
	if ((Joueures[i].compte >= Proprietes[Joueures[i].position].prix)&&(strcmp(Proprietes[Joueures[i].position].proprietaire, "aucun proprietaire") == 0)&&(Proprietes[Joueures[i].position].hypotheque == false))//
    {
...
void offre(int player, int numplayer)
{
    ...
    int i=player;
			menuventeAuxEncheres:
				...
				//Abandonner
				case 2:
					printf("vous avez renonce a faire une offre.");
					break;
...
void construireHotel(int player)
{
	...
	for (int j = 0; j < 40; j++)//
        {
            if ((strcmp(Proprietes[j].proprietaire, Joueures[i].Nom) == 0)&&(strcmp(Proprietes[j].Couleur,"Gare") != 0)&&(strcmp(Proprietes[j].Couleur, "Services") != 0))//
                {
                    printf(" %d   * %s\n",j,Proprietes[j].Nom);//
                    nombreDepropriete++;
                }
    ...
    if (nombreDepropriete>0)
    {
        ...
        scanf("%d", &numerodelapropriete);//
        }while((strcmp(Proprietes[numerodelapropriete].proprietaire, Joueures[i].Nom) != 0)&&(strcmp(Proprietes[numerodelapropriete].Couleur,"Gare") == 0)&&(strcmp(Proprietes[numerodelapropriete].Couleur, "Services") == 0));//
        ...
        if ((Proprietes[numerodelapropriete].nombreDeMaisons >= 4)&&(Proprietes[numerodelapropriete].nombreHotel <1)&&((Joueures[i].compte - Proprietes[numerodelapropriete].prixMaison)>0))
        {
            if (Batiments.nHotel>0)
            {
                ...
                printf("Cette propriete a maintenant %d maison(s) et un Hotel.\n", Proprietes[numerodelapropriete].nombreDeMaisons); //
            }
            else
            {
...
void construireMaison(int player)
{
    ...
    if (nombreDepropriete>0)
    {
        ...
        for (int l = 0; l < 40; l++)//
            ...
            else if ((Couleurcompteur == 2)&&(strcmp(Proprietes[numerodelapropriete].Couleur,"Marron") == 0)&&((Joueures[i].compte -= Proprietes[numerodelapropriete].prixMaison)>0))//
            {
                    if (Batiments.nMaison>0)
                        {
                            if (Proprietes[numerodelapropriete].nombreDeMaisons<4)
            ...
            else if ((Couleurcompteur == 2)&&(strcmp(Proprietes[numerodelapropriete].Couleur,"Bleu Fonce") == 0)&&((Joueures[i].compte -= Proprietes[numerodelapropriete].prixMaison)>0))//
            {
                    if (Batiments.nMaison>0)
                        {
                            if (Proprietes[numerodelapropriete].nombreDeMaisons<4)
        ...
        if (Joueures[i].position ==22)
        {
            ...
            for (j=0;j<nJoueures;j++)
            {
                if ((strcmp(Proprietes[Joueures[i].position].proprietaire, Joueures[j].Nom) == 0))
                {
                    ...
                    printf("Lancer: %d + %d = %d\n",de3, de2, de3 + de2);//
                    printf("Vous devez payer 10 fois le montant indiquer par les des soit %d\n",((de3+de2)*10));//
                    Joueures[i].compte -= ((de3+de2)*10);
                    Joueures[j].compte += ((de3+de2)*10);
                }
            }
        }
        if (Joueures[i].position ==36)
        {
            Joueures[i].position=12;
            for (j=0;j<nJoueures;j++)
            {
...
menuInitial://
	...
	case 2: printf("Pas encore implémenté!"); //A faire
		break;
    case 3: printf("Pas encore implémenté!"); //A faire
		break;
	case 4:
...
nouveauJeu ://
	...
	scanf("%d", &plateau);//
    }while(((plateau < 1)||(plateau > 6))&&(plateau!=101917));
	if (plateau==1)
    {
       initialiseTable();//
    }
	...
	do
	{
		...
		for (int i = 0; i < nJoueures; i++)//
		{
			...
			if ((Proprietes[Joueures[i].position].prix != 0)&&(strcmp(Proprietes[Joueures[i].position].Couleur, "Gare") != 0)&&(strcmp(Proprietes[Joueures[i].position].Couleur, "Services") == 0))//
			{
				...
				printf(" ___________________________________\n");
				printf(" |                                  |\n");
				printf(" |%-34.34s|   * Propriete : %s", Proprietes[Joueures[i].position].Nom, Proprietes[Joueures[i].position].proprietaire);//
        if(Proprietes[Joueures[i].position].hypotheque== true){printf("\n |                                  |   * Hypoteque        : OUI\n");}
          else {printf("\n |                                  |   * Hypoteque        : NON\n");}
				printf(" |couleur %-11.11sLe prix  $%4d |   * HOTEL        : %d\n", Proprietes[Joueures[i].position].Couleur, Proprietes[Joueures[i].position].prix, Proprietes[Joueures[i].position].nombreHotel);//
				printf(" | -------------------------------- |\n");
			...
			{
			    ancienneposition = Joueures[i].position;//
				printf("\n             %s           \n", Proprietes[Joueures[i].position].Nom);//
				printf("tirer une carte CHANCE\n");//
				printf("\n /////////////////////////////////////// \n");
				carteChance(i,nJoueures);
				printf("\n /////////////////////////////////////// \n");
				if ((Joueures[i].position == 0) || (Joueures[i].position < (ancienneposition-3)))//
			{
			    printf("\n /////////////////////////////////////// \n");
				printf("\n Passe par depart. Recevez 200 euros..\n");//
				Joueures[i].compte += 200;//
			...
			if (strcmp(Proprietes[Joueures[i].position].Nom, "Caisse de communaute") == 0)//
			{
			    ancienneposition = Joueures[i].position;//
				printf("\n             %s           \n", Proprietes[Joueures[i].position].Nom);//
            ...
            if (strcmp(Proprietes[Joueures[i].position].Nom, "TAXE DE LUXE") == 0)//
			{
				printf("\n             %s           \n", Proprietes[Joueures[i].position].Nom);//
			...
			if (strcmp(Proprietes[Joueures[i].position].Nom, "IMPOTS SUR LE REVENU") == 0)//
			{
				printf("\n             %s           \n", Proprietes[Joueures[i].position].Nom);//
            ...
            if ((strcmp(Proprietes[Joueures[i].position].Nom, "PRISON - VISITEUR") == 0) && (strcmp(Proprietes[i].Nom, "PARKING GRATUIT") == 0))//
            {
                printf("\n             %s           \n", Proprietes[Joueures[i].position].Nom);//
            }
			if (strcmp(Proprietes[Joueures[i].position].Nom, "VA EN PRISON") == 0)//
			{
				Joueures[i].prison = true;
			}
            printf("\nplace actuel = Case %d - %s\n", Joueures[i].position, Proprietes[Joueures[i].position].Nom);//
        ...
        menuJoueur://
			...
			if (((strcmp(Proprietes[Joueures[i].position].proprietaire, "aucun proprietaire") == 0)&&(Proprietes[Joueures[i].position].prix != 0)&&(Joueures[i].prison==false))||(Proprietes[Joueures[i].position].hypotheque == true))// en fonction des cases
			{
			...
			case 3:
			    if (((strcmp(Proprietes[Joueures[i].position].proprietaire,Joueures[i].Nom) != 0)&&(Proprietes[Joueures[i].position].prix != 0)&&(strcmp(Proprietes[Joueures[i].position].proprietaire, "aucun proprietaire") != 0))||(Proprietes[Joueures[i].position].hypotheque== true))// en fonction des cases
                    {printf("\n ////////// Joueur %d - %s ////////// \n", i + 1, Joueures[i].Nom);offre(i,nJoueures);printf("\n /////////////////////////////////////// \n");goto menuJoueur;}//
                    goto menuJoueur;//
				break;//
			...
			case 4:
			    if ((strcmp(Proprietes[Joueures[i].position].proprietaire, Joueures[i].Nom) == 0)&&(Proprietes[Joueures[i].position].prixMaison>0))
                    {printf("\n ////////// Joueur %d - %s ////////// \n", i + 1, Joueures[i].Nom);construireMaison(i);printf("\n /////////////////////////////////////// \n");goto menuJoueur;}//
                else goto menuJoueur;//
				break;//
			...
			case 5:
			    if ((strcmp(Proprietes[Joueures[i].position].proprietaire, Joueures[i].Nom) == 0)&&(Proprietes[Joueures[i].position].prixMaison>0))
                    {printf("\n ////////// Joueur %d - %s ////////// \n", i + 1, Joueures[i].Nom);construireHotel(i);printf("\n /////////////////////////////////////// \n");goto menuJoueur;}//
                    goto menuJoueur;//
				break;//
			...
			case 6:
			    if ((strcmp(Proprietes[Joueures[i].position].proprietaire, Joueures[i].Nom) == 0))
                    {printf("\n ////////// Joueur %d - %s ////////// \n", i + 1, Joueures[i].Nom);vendreConstruction(i);printf("\n /////////////////////////////////////// \n");goto menuJoueur;}//
                 else goto menuJoueur;//
				break;//
			...
			case 7:
			    if (strcmp(Proprietes[Joueures[i].position].proprietaire,Joueures[i].Nom ) == 0)
                    {printf("\n ////////// Joueur %d - %s ////////// \n", i + 1, Joueures[i].Nom);hypothequerPropriete(i);printf("\n /////////////////////////////////////// \n");goto menuJoueur;}//
                else goto menuJoueur;//
				break;//
            case 8:
                menuPrincipal:
                ...
                case 1: goto nouveauJeu;//
                    break;
                case 2: goto menuJoueur; //A faire
                    break;
                case 3: printf("Pas encore implémenté!"); //A faire
                    break;
                case 4:
